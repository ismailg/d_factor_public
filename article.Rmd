...
<!-- Trust and cooperation are fundamental to human social interaction and economic exchange [@OstromWalker2003; @Yamagishi2011]. The trust game, introduced by @Berg1995, provide a powerful and widely adopted tool for investigating the dynamics of trust (the willingness to make oneself vulnerable to another's actions) and trustworthiness (or reciprocity; honoring the trust placed in oneself) in controlled settings (see @Camerer2003; [@JohnsonMislin2011] for meta-analysis). While numerous studies have explored various personality traits as predictors of behavior in trust games, recent developments in personality psychology offer new avenues for understanding the underlying factors that influence trustworthiness. -->

<!-- While situational factors undoubtedly influence behavior in these games, stable individual differences in personality traits are also significant predictors (e.g., [@EvansRevelle2008; @MullerSchwieren2020]). Among the most potent predictors of antisocial or self-interested behavior are the so-called “dark” personality traits – typically conceptualized as the Dark Triad of Machiavellianism, Narcissism, and subclinical Psychopathy [@PaulhusWilliams2002]. These traits share common threads of manipulativeness, callousness, antagonism, and self-enhancement. However, their considerable overlap and the proliferation of related constructs have led to calls for a more unified theoretical framework  [@Zettler2021]. The Dark Factor of Personality (D-factor), proposed by @Moshagen2018, represents a unified construct encompassing various malevolent personality traits. Defined as the general tendency to maximize one's utility at the expense of others, accompanied by beliefs that serve as justifications, the D-factor offers a comprehensive framework for understanding antisocial tendencies. This construct incorporates elements of Machiavellianism, Narcissism, and Psychopathy - traits previously linked to reduced trustworthiness in economic games [@Ibanez2016; @Gunnthorsdottir2002]. Theoretically, D represents the shared variance among dark traits ([@HilbigZettlerMoshagenThielmann2021; @Zettler2021]) and provides a parsimonious explanation for their correlations. -->

<!-- Research has consistently demonstrated negative correlations between dark personality traits and cooperative behavior, but primarily in one-shot or non-repeated economic games. A meta-analysis by @Zhao2015 found that dark triad traits negatively predict cooperation across different single-encounter economic paradigms, including dictator games, ultimatum games, and one-shot prisoner's dilemmas. Similarly, @Thielmann2019 observed that dark personality traits predict dishonest behavior in discrete economic interactions without repeated encounters. These findings suggest that the D-factor, as a unifying construct, may serve as a potent predictor of untrustworthy behavior in trust games. -->

<!-- While the D-factor has shown associations with selfish behavior in dictator games [@Moshagen2020] and lower levels of honesty-humility [@Zettler2021], its specific impact on trustworthiness in *repeated* trust games remains unexplored. -->
<!-- @Gong2019 examined the relationship between psychopathic traits and behavior in a modified trust game. However, their design involved multiple different partners rather than repeated interactions with the same opponent. Similarly, @Rosenberger2019 examined fairness norm violations in violent offenders during a repeated trust game, finding that antisocial traits (Factor 2 of psychopathy) rather than interpersonal/affective traits (Factor 1) were associated with reduced reciprocity. However, this study focused on clinical psychopathy in offenders rather than the D-factor in the general population. This gap is particularly notable given the unique features of the repeated trust game, which allows for the development of reputation and the potential for strategic behavior over multiple interactions [@Bohnet2004]. -->
...
<!-- The present study addresses several important gaps in our understanding of how dark personality traits influence economic behavior. First, by using a repeated trust game paradigm with 25 rounds, we can examine whether High-D individuals demonstrate strategic patterns that evolve over time, such as initial trust-building followed by exploitation. Second, to overcome the limitations of using human confederates and gain experimental control over the interaction partner's strategy, we employ a novel methodology using Hidden Markov Model (HMM) agents as investors.  -->

<!-- HMMs are computational models well-suited for capturing sequences of behavior with underlying latent states [@Rabiner1989]. By training these models on behavioral data from large samples of humans playing prior trust games, we can create standardized interaction partners that exhibit realistic, human-like response patterns yet allow for precise manipulation of their strategies. This approach offers a powerful blend of experimental control and ecological validity. Critically, we manipulate opponent "exploitability" by developing two distinct HMM investor types: a 'human-like' agent designed to mimic typical human behavior with relatively stable transitions between trust states (low, medium, high), and a 'responsive' agent specifically programmed to adapt its trust state more rapidly and deterministically based on the participant's (trustee's) return behavior in the previous round. This manipulation allows us to directly test whether individuals high in D demonstrate sophisticated strategic adaptation by adjusting their exploitative behavior based on the perceived predictability and responsiveness of their interaction partner.  -->
...
<!-- Trust and cooperation form the bedrock of human social and economic life (e.g., [@OstromWalker2003; @Yamagishi2011]), enabling exchanges that range from personal relationships to global commerce. Understanding the factors that shape these fundamental behaviors is crucial. Laboratory paradigms, particularly the trust game introduced by @Berg1995, provide a powerful and widely adopted tool for investigating the dynamics of trust (the willingness to make oneself vulnerable to another's actions) and trustworthiness (or reciprocity; honoring the trust placed in oneself) in controlled settings (see @Camerer2003; [@JohnsonMislin2011] for meta-analysis). -->

<!-- While situational factors undoubtedly influence behavior in these games, stable individual differences in personality traits are also significant predictors (e.g., [@EvansRevelle2008; @MullerSchwieren2020]). Indeed, a broad range of personality characteristics, including factors from the Big Five and HEXACO models, have been linked to variations in prosocial behavior within economic games (see @Thielmann2020personality for a meta-analysis). Among the most potent predictors of antisocial or self-interested behavior are the so-called “dark” personality traits – typically conceptualized as the Dark Triad of Machiavellianism, Narcissism, and subclinical Psychopathy [@PaulhusWilliams2002]. These traits share common threads of manipulativeness, callousness, antagonism, and self-enhancement. However, their considerable overlap and the proliferation of related constructs have led to calls for a more unified theoretical framework (e.g., [@Zettler2021]). -->

<!-- The Dark Factor of Personality (D-factor), proposed by @Moshagen2018 in Psychological Review, addresses this need by conceptualizing a common core underlying aversive traits. D is defined as “the general tendency to maximize one’s individual utility — disregarding, accepting, or malevolently provoking disutility for others —, accompanied by beliefs that serve as justifications” [@Moshagen2018]. This framework posits that specific dark traits (like those in the Dark Triad, but also others such as spitefulness or sadism) arise as manifestations of this general disposition, similar to how the g-factor conceptualizes general intelligence ([@Moshagen2018; @MoshagenZettlerHilbig2020Assessment]). Theoretically, D represents the shared variance among dark traits ([@HilbigZettlerMoshagenThielmann2021; @Zettler2021]) and provides a parsimonious explanation for their correlations. -->

<!-- Research consistently links dark traits, and D itself, to reduced cooperation, honesty, and prosociality in various contexts. Much of this evidence, however, comes from one-shot or non-repeated economic games. Meta-analyses confirm negative associations between Dark Triad traits and cooperation in single-encounter dictator games, ultimatum games, and prisoner's dilemmas [@Zhao2015]. Studies focusing specifically on D have shown it predicts selfish behavior in dictator games [@MoshagenZettlerHilbig2020Assessment]) and is negatively related to honesty-humility, a key predictor of fairness [@HilbigZettlerMoshagenThielmann2021]. Further work demonstrates D consistently predicts antisocial choices across a range of economic games, largely subsuming the predictive power of the individual Dark Tetrad traits [@HilbigThielmann2025]. While informative, these single-interaction studies cannot capture the crucial dynamics of repeated interactions, where reputation formation, strategic learning, and the potential for both sustained cooperation and calculated exploitation unfold over time [@Bohnet2004]. -->

<!-- Understanding how D influences behavior in repeated exchanges is critical, as the strategic manipulation and long-term orientation associated with traits like Machiavellianism (a key component reflected in D) may only become fully apparent over multiple rounds [@Jones2009]. The repeated trust game, involving multiple rounds between the same partners, is ideally suited for studying these dynamics. Yet, its application to the unifying D-factor construct remains largely unexplored. Previous relevant studies using repeated games often focused on specific clinical populations (e.g., psychopathy factors in offender samples; @Rosenberger2019) or employed paradigms involving sequences of different partners rather than sustained interaction with a single counterpart (e.g., @Gong2019), limiting insights into reputation-based strategies linked to D in the general population. -->

<!-- The present study bridges these gaps by investigating how D-factor influences behavior across 25 rounds of a repeated trust game. To overcome the limitations of using human confederates and gain experimental control over the interaction partner's strategy, we employ a novel methodology using Hidden Markov Model (HMM) agents as investors. HMMs are computational models well-suited for capturing sequences of behavior with underlying latent states [@Rabiner1989]. By training these models on behavioral data from large samples of humans playing prior trust games, we can create standardized interaction partners that exhibit realistic, human-like response patterns yet allow for precise manipulation of their strategies. This approach offers a powerful blend of experimental control and ecological validity (cf. axiomatic vs. simulation-based approaches in computational social science; @MacyWiller2002). Critically, we manipulate opponent predictability by developing two distinct HMM investor types: a 'human-like' agent designed to mimic typical human behavior with relatively stable transitions between trust states (low, medium, high), and a 'responsive' agent specifically programmed to adapt its trust state more rapidly and deterministically based on the participant's (trustee's) return behavior in the previous round. This manipulation allows us to directly test whether individuals high in D demonstrate sophisticated strategic adaptation by adjusting their exploitative behavior based on the perceived predictability and responsiveness of their interaction partner. -->

<!-- Therefore, this study offers several unique contributions to the literature on personality, trust, and economic decision-making: 1) It provides the first examination of the unified D-factor within the dynamic context of a multi-round (25-round) repeated trust game. 2) It introduces an innovative experimental methodology using adaptive HMM agents, derived from human data and varying in responsiveness, to probe strategic adaptation linked to personality. 3) It investigates not only the enactment of exploitative strategies associated with D but also, critically, the potential limits of these strategies when interacting with partners who can adapt defensively. -->

<!-- Based on the theoretical conceptualization of D as involving justified utility maximization at others' expense, and considering the dynamics of repeated games with varying opponent responsiveness, we formulated the following hypotheses: -->

<!-- (H1) High-D individuals will exhibit lower overall trustworthiness (i.e., return lower proportions of the investment) compared to low-D individuals, with this difference becoming more pronounced across the 25 rounds of the game. -->

<!-- (H2) High-D individuals will demonstrate greater strategic adaptation to opponent predictability. Specifically, they will decrease their reciprocity more steeply over time when interacting with the more exploitable 'human-like' HMM. -->

<!-- (H3) High-D individuals will perceive their interaction partners more negatively (e.g., rate them as less cooperative and trustworthy) compared to low-D individuals, potentially irrespective of the HMM opponent's programmed behavior. -->
...
participant_d_levels <- final_data %>%
  distinct(id, d_level) # Ensure this pulls rows with "low_D" and "high_D"

# Merge with demographic subset and perform conversions
demographics_with_dlevel <- participant_d_levels %>%
  inner_join(demographic_subset, by = c("id" = "Participant.id")) %>%
  mutate(
...
# --- 3. Categorical Variable Summary & Test (Function) ---
summarize_categorical <- function(data, variable_name, characteristic_label) {
  var_sym <- sym(variable_name)

  # Calculate N and Percent per group
  summary_stats <- data %>%
    # Ensure factor levels are respected even if count is 0 for a group
    count(d_level, {{ var_sym }}, .drop = FALSE) %>%
    group_by(d_level) %>%
    # Avoid division by zero for percentages
    mutate(
        total_n = sum(n),
        prop = ifelse(total_n == 0, 0, n / total_n)
      ) %>%
    ungroup() %>%
    mutate(summary_str = sprintf("%d (%.1f%%)", n, prop * 100)) %>%
    dplyr::select(d_level, {{ var_sym }}, summary_str) %>%
    pivot_wider(names_from = d_level, values_from = summary_str, values_fill = "0 (0.0%)")

  # Perform test (Chi-squared or Fisher's Exact)
  p_value_str <- NA_character_
  # Only run test if both groups have data
  if (n_low > 0 && n_high > 0) {
      tryCatch({
          # Ensure table has both dimensions > 0 before testing
          cont_table <- table(data$d_level, data[[variable_name]])
          if(all(dim(cont_table) > 0)) {
              expected_counts <- suppressWarnings(chisq.test(cont_table)$expected)
              if (any(expected_counts < 5, na.rm = TRUE) && nrow(cont_table) <= 2 && ncol(cont_table) <= 2) {
                  test_result <- fisher.test(cont_table)
              } else {
                  test_result <- suppressWarnings(chisq.test(cont_table, simulate.p.value = any(expected_counts < 5, na.rm = TRUE)))
              }
  ...
  header_row <- data.frame(
    Characteristic = sprintf("%s, n (%%)", characteristic_label),
    Low = "",
    High = "",
    P_value = p_value_str
  )

  # *** CORRECTION HERE: Select/Rename pivoted columns with backticks ***
  level_rows <- summary_stats %>%
    mutate(Characteristic = paste0("  ", !!var_sym)) %>%
    # Ensure columns exist before selecting
    dplyr::select(Characteristic, any_of(c("low_D", "high_D"))) %>%
    # Rename using backticks for source columns
...
# --- 4. Apply to Sex and Ethnicity ---
# Ensure Sex and Ethnicity levels don't contain issues like "CONSENT_REVOKED"
# Add filtering here if needed, e.g.:
# demographics_for_table <- demographics_with_dlevel %>%
#    filter(!Sex %in% c("CONSENT_REVOKED"), !Ethnicity.simplified %in% c("CONSENT_REVOKED"))
# sex_rows <- summarize_categorical(demographics_for_table, "Sex", "Gender")
# ethnicity_rows <- summarize_categorical(demographics_for_table, "Ethnicity.simplified", "Ethnicity")

# Using original data for now, assuming levels are clean:
...
# *** CORRECTION HERE: Update column names using correct N values ***
...
# cat("- Categorical variables presented as n (%); compared using Chi-squared or Fisher's Exact test.\n")
...
<!-- In each phase of the experiment, participants played a 25-round RTG [@Berg1995] in the trustee -->
...
<!-- The computerised investor consisted of an HMM -->
<!-- trained on an independent existing behavioral RTG dataset of human -->
<!-- investors. This data-driven approach thus sought to learn an investor -->
<!-- strategy that mimics human-like interactions. The dataset used for -->
<!-- training consists of 388 ten round games with the same player (full -->
<!-- details can be found in the Supplementary Information). On this dataset, the HMM was inferred with three latent states that could be interpreted as reflecting a “low-trust”, a “medium-trust”, and a -->
...
<!-- round (see Figure \ref{fig:combinedPlots}.C)). For example, the higher the return received by the investor as compared to their investment in a round, the more likely the HMM investor is to transition to higher trust states in the next round.  The initial state for the -->
<!-- HMM investor in each instance of the game was set to the “mid-trust” -->
<!-- state. More details on how the HMM state conditional probabilities and -->
...
<!-- In addition to the Human-like HMM resulting from fitting to existing datasets of dyadic play, we created a more Responsive HMM. This was achieved by adjusting the parameters of the Human-like HMM to alter the state transition probabilities. Specifically, the transition probability for remaining in the "medium-trust" state was set to zero when net returns were significantly non-nil. This modification makes the agent more sensitive to changes in return behavior - when a participant returns significantly more or less than the investment amount, the Responsive HMM will quickly shift to either the high-trust or low-trust state rather than staying in the medium-trust state. In practical terms, this agent adapts more rapidly to participant behavior, rewarding generosity with higher investments more quickly and punishing exploitation more swiftly than the Human-like HMM. The resulting transition function is illustrated in Figure \ref{fig:combinedPlots}.D. The state-conditional policies and the transition function in the other latent states remained unchanged.  -->
...
<!-- Low-D individuals show significant reciprocity (positive slopes) with both opponents. Low-D individuals show stronger reciprocity with the responsive opponent -->

<!-- High D individuals show no significant reciprocity with either opponent type -->

<!-- The largest difference in reciprocity is between high and low D individuals when facing the responsive opponent -->

<!-- This suggests that Low-D individuals are more responsive to the level of investment they receive, especially in responsive interactions, while High D individuals maintain more stable return rates regardless of investment received. This could indicate that High D individuals are less influenced by their partner's behavior, while Low-D individuals adjust their behavior more in response to their partner's actions. -->
...
<!-- High-D participants who faced the stable opponent first showed a strategic pattern: they significantly decreased returns over rounds for high investments ($p < .0001$) and medium investments ($p = .0001$), but not for low investments ($p = .84$). This suggests calculated exploitation specifically targeting more exploitable partners. In contrast, High-D participants who faced the responsive opponent first showed the opposite pattern: significant decreases for low investments ($p = .007$) and medium investments ($p = .007$), but not for high investments ($p = .63$). -->

<!-- Low-D participants displayed fundamentally different behavior:  they showed no significant changes in returns across investments.  -->
...
<!-- *Stable First*: low investments (slope = `r sprintf("%.5f", low_D_stable_low$slope)`, `r format_p(low_D_stable_low$p_value)`), medium investments (slope = `r sprintf("%.5f", low_D_stable_med$slope)`, `r format_p(low_D_stable_med$p_value)`), high investments (slope = `r sprintf("%.5f", low_D_stable_high$slope)`, `r format_p(low_D_stable_high$p_value)`). *responsive First*: low investments (slope = `r sprintf("%.5f", low_D_volatile_low$slope)`, `r format_p(low_D_volatile_low$p_value)`), medium investments (slope = `r sprintf("%.5f", low_D_volatile_med$slope)`, `r format_p(low_D_volatile_med$p_value)`), high investments (slope = `r sprintf("%.5f", low_D_volatile_high$slope)`, `r format_p(low_D_volatile_high$p_value)`). -->


<!-- All of this supports the notion that higher levels of the Dark Factor are associated with more consistent declines in trust or reciprocity over repeated rounds, whereas lower Dark Factor individuals are more variable and sometimes maintain stable behavior (particularly in responsive-first) -->
...
<!-- <!-- Third, our computational modeling approach suggested differences in learning and decision strategies between high and Low-D individuals, but further refinement of these models could provide deeper insights into the cognitive mechanisms underlying these behavioral differences. More sophisticated models incorporating theory of mind and planning horizons may better capture the strategic aspects of exploitation. --> 
...
<!-- High-D participants showed relatively stable returns across investor states, particularly with the Responsive investor, suggesting a form of behavioral rigidity rather than strategic flexibility. -->

<!-- This behavioral inflexibility was especially evident in the Responsive HMM condition, where High-D participants maintained consistent return rates regardless of the investor's state. In contrast, Low-D participants showed marked sensitivity to investor states, adjusting their returns upward as the investor's state improved from unhappy to happy. This pattern held across both human-like and Responsive HMM conditions, though it was more pronounced with the Responsive investor. These findings suggest that contrary to the Machiavellian tendency for strategic manipulation, High-D individuals might actually be less adept at reading and responding to social cues in economic interactions. -->

<!-- One possible explanation for this unexpected pattern lies in the fundamental nature of the D-factor as "the tendency to maximize one's individual utility at the expense of others with self-justifying beliefs." The behavioral rigidity we observed might represent a form of defensive strategy - by maintaining stable (and relatively lower) returns regardless of the investor's state, High-D participants could be prioritizing consistent personal gain over reciprocity. This interpretation aligns with recent work suggesting that dark personality traits might manifest not just as active exploitation, but as a general insensitivity to social cues that would typically motivate cooperative behavior. -->
